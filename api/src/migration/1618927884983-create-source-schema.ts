...
export class createSourceSchema1618927884983 implements MigrationInterface {
    name = 'createSourceSchema1618927884983'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sources" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "url" character varying, "citation" character varying NOT NULL, "comments" text, "mediaType" "sources_mediatype_enum" NOT NULL, "projectId" uuid, CONSTRAINT "PK_85523beafe5a2a6b90b02096443" PRIMARY KEY ("id"))`);
